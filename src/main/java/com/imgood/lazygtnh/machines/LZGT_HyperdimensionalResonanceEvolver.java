...
public class LZGT_HyperdimensionalResonanceEvolver extends GTCM_MultiMachineBase<LZGT_HyperdimensionalResonanceEvolver> {
    ...
    public LZGT_HyperdimensionalResonanceEvolver(String aName) {
        super(aName);
    }
 ...
 */
    ...
    protected GT_Multiblock_Tooltip_Builder createTooltip() {
        ...
        tt.addMachineType(LZGTTextLocalization.Tooltip_HyperdimensionalResonanceEvolver_MachineType)
            .addInfo(LZGTTextLocalization.Tooltip_HyperdimensionalResonanceEvolver_Controller)
            .addInfo(LZGTTextLocalization.Tooltip_HyperdimensionalResonanceEvolver_01)
            .addInfo(LZGTTextLocalization.Tooltip_HyperdimensionalResonanceEvolver_02)
            .addInfo(LZGTTextLocalization.Tooltip_HyperdimensionalResonanceEvolver_03)
            .addInfo(LZGTTextLocalization.Tooltip_HyperdimensionalResonanceEvolver_04)
            .addInfo(LZGTTextLocalization.Tooltip_HyperdimensionalResonanceEvolver_05)
            .addInfo(LZGTTextLocalization.Tooltip_HyperdimensionalResonanceEvolver_06)
            .addInfo(LZGTTextLocalization.Tooltip_HyperdimensionalResonanceEvolver_07)
            .addInfo(LZGTTextLocalization.Tooltip_HyperdimensionalResonanceEvolver_08)
            .addInfo(LZGTTextLocalization.Tooltip_HyperdimensionalResonanceEvolver_09)
            .addInfo(LZGTTextLocalization.Tooltip_HyperdimensionalResonanceEvolver_10)
            .addInfo(LZGTTextLocalization.Tooltip_HyperdimensionalResonanceEvolver_11)
