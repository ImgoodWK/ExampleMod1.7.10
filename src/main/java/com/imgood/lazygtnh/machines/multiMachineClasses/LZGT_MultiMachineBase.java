package com.imgood.lazygtnh.machines.multiMachineClasses;
...
public abstract class LZGT_MultiMachineBase<T extends LZGT_MultiMachineBase<T>>
    ...
    public String[] getInfoData() {
        ...
        ret[origin.length] = EnumChatFormatting.AQUA + LZGTTextHandler.texter("Parallels", "MachineInfoData.Parallels")
            + ": "
            + EnumChatFormatting.GOLD
            + this.getLimitedMaxParallel();
        ret[origin.length + 1] = EnumChatFormatting.AQUA + LZGTTextHandler
            .texter("Speed multiplier", "MachineInfoData.SpeedMultiplier") + ": " + EnumChatFormatting.GOLD + dSpeed;
        ret[origin.length + 2] = EnumChatFormatting.AQUA + LZGTTextHandler
