...
import static com.imgood.lazygtnh.utils.Enums.MOD;
...
import com.imgood.lazygtnh.utils.AutoMap;
...
public class TexturesGtBlock {
    ...
    public static class CustomIcon implements IIconContainer, Runnable {
        ...
        public CustomIcon(final String aModID, final String aIconName) {
            ...
            LazyGTNH.logger.warn("Constructing a Custom Texture. " + this.mIconName);
